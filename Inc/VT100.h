...
#define CUU(x) 					"\033[xA" 	//Move cursor up n lines 	    CUU
#define CUD(x) 					"\033[xB" 	//Move cursor down n lines 	CUD
#define CUF(x) 					"\033[xC" 	//Move cursor right n lines 	CUF
#define CLR_Line			"\033[K" 	//clear line from cursor right
